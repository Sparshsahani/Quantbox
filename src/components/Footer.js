  ...
  return (
    <>
      <section className="py-10 bg-quant-orange 2xl:max-w-[1920px] mx-auto">
        <footer className="mx-5 lg:mx-20 xl:mx-16 2xl:mx-31">
          <div className="relative flex flex-col max-xl:flex-wrap items-center justify-around lg:justify-between xl:justify-between 2xl:justify-between py-8 text-white md:flex-row px-5">
            ...
            <div className="max-xl:w-full md:text-justify md:mx-2 lg:mx-0 xl:mx-10 2xl:mx-38">
          ...
          <div className="relative flex flex-col py-8 text-white mt-10 items-center justify-between md:flex-row md:mx-10 lg:justify-center lg:mx-30 xl:mx-0 xl:flex-nowrap xl:justify-between 2xl:items-center 2xl:mx-0 2xl:justify-center max-2xl:flex-wrap 2xl:mt-0 ">
            <ul className="w-[90%] mx-5 flex flex-col md:flex-row flex-wrap gap-x-8 uppercase custom-footer-header space-y-3 md:space-y-0 justify-start md:justify-between xl:justify-between 2xl:justify-start font-inter-sans font-medium">
              <li>privacy</li>
            ...
            <div className="w-[90%]">
              <div className="flex items-center flex-wrap justify-center md:justify-center max-xl:mt-10 xl:justify-end 2xl:justify-end 2xl:mr-20 gap-x-4 duration-300">
      ...
      <div className="w-full h-[10vh] max-sm:px-5 max-sm:text-center text-quant-white text-[14px] bg-black flex items-center justify-start max-xl:justify-center lg:px-65 xl:px-20 2xl:px-35 2xl:max-w-[1920px] mx-auto">
        <h5 className="">
